...
2) Напишите функцию, которая принимает в себя 4 числа и возвращает самое большее из них. Если один из аргументов 
...
function getTimeFromMinutes(minuts) {
    if (typeof(minuts) !== 'number' || Number.isInteger(minuts) === false || minuts < 0) {
    ...
    return `Это ${Hours} ${str} и ${MinutS} минут`;
}
getTimeFromMinutes(235);
